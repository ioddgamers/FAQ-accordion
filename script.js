function displayAnswer(clickedElement) { //clickedElement is the element that was clicked
    ...
    if (image.src.includes("plus")) { //Checking if the src attribute of my image contains the "plus" string 
        image.src = "/faq-accordion-main/assets/images/icon-minus.svg"; //If it does, I want to change the image to the src provided
    } else {
        image.src = "/faq-accordion-main/assets/images/icon-plus.svg";//If it doesn't, leave the image
    }
}